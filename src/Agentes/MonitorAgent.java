...
////        ipsParaBloquear.add("10.0.0.45");
        ...
        if (args != null && args.length > 0) {
            ...
            if (args[0] instanceof String[]) {
                ...
                //Equivalente a
//                for (int i = 0; i < ipsRecebidos.length; i++) {
//                    ipsParaBloquear.add(ipsRecebidos[i]);
//                    System.out.println("IP adicionado para bloqueio (array): " + ipsRecebidos[i]);
//                }
            }
...
// javac -d bin1 -cp "C:\Users\pinhe\Downloads\JADE-all-4.6.0\JADE-bin-4.6.0\jade\lib\jade.jar"  C:\TEP\.idea\Tep_1.0\Agentes.MonitorAgent.java
//jar cvf ./Agentes.MonitorAgent.jar Agentes.MonitorAgent/*.class